...
public class LocalDataSource<T> extends SQLiteOpenHelper
{
    ...
    public LocalDataSource(Context context, String name, String primaryKeyName, String primaryKeyType, String[] columnNames, String[] columnTypes, int version)
    {
    ...
    public long updatePerson(Celebrity newValue) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        SQLiteDatabase database = getWritableDatabase();
